...
package droid.game.android.support.v7.widget.helper;
...
import droid.game.android.support.v4.view.GestureDetectorCompat;
import droid.game.android.support.v4.view.ViewCompat;
import droid.game.android.support.v7.widget.LinearLayoutManager;
import droid.game.android.support.v7.widget.RecyclerView;
import droid.game.android.support.v7.widget.RecyclerView.OnItemTouchListener;
import droid.game.android.support.v7.widget.RecyclerView.ViewHolder;
...
import static droid.game.android.support.v7.util.Utils.dpToPx;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            ...
            mMaxSwipeVelocity = resources
                    ...
                    */
            mSwipeEscapeVelocity = dpToPx(120);
            mMaxSwipeVelocity = dpToPx(800);
            setupCallbacks();
        }
    }
    ...
    public abstract static class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                ...
                */
                mCachedMaxScrollSpeed = dpToPx(20);
            }
