...
import static droid.game.android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
import static droid.game.android.support.v7.widget.RecyclerView.ViewHolder;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_POST;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_PRE;
import static droid.game.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;

import droid.game.annotation.NonNull;
import droid.game.annotation.Nullable;
import droid.game.annotation.VisibleForTesting;
import droid.game.android.support.v4.util.ArrayMap;
import droid.game.android.support.v4.util.LongSparseArray;
import droid.game.android.support.v4.util.Pools;
/**
