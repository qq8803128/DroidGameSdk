 ...
 * list
 * such that it can be bound to a {@link droid.game.android.support.v7.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * {@link droid.game.android.support.v7.widget.RecyclerView}, you can return the particular field that
