...
public class ActivityManagerProxy implements InvocationHandler {
    ...
    public ActivityManagerProxy(VirtualApk pluginManager, IActivityManager activityManager) {
    ...
    protected Intent wrapperTargetIntent(Intent target, ServiceInfo serviceInfo, Bundle extras, int command) {
        ...
        String pluginLocation = ((LoadedPlugin)mPluginManager.getLoadedPlugin(target.getComponent())).getLocation();
