...
public class PluginUtil {
    ...
    public static int getTheme(Context context, ComponentName component) {
        LoadedPlugin loadedPlugin = VirtualApk.getInstance(context).getLoadedPlugin(component);
    ...
    public static void hookActivityResources(Activity activity, String packageName) {
        ...
        try {
            ...
            final LoadedPlugin plugin = VirtualApk.getInstance(activity).getLoadedPlugin(packageName);
