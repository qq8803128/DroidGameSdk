...
public class ComponentsHandler {
    ...
    private VirtualApk mPluginManager;
    private StubActivityInfo mStubActivityInfo = new StubActivityInfo();


    private HashMap<ComponentName, Service> mServices = new HashMap<ComponentName, Service>();
    private HashMap<IBinder, Intent> mBoundServices = new HashMap<IBinder, Intent>();
    private HashMap<Service, AtomicInteger> mServiceCounters = new HashMap<Service, AtomicInteger>();

    public ComponentsHandler(VirtualApk pluginManager) {
