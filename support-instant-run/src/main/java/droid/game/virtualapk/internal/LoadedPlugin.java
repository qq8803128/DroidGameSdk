...
import droid.game.virtualapk.internal.utils.DexUtil;
import droid.game.virtualapk.internal.utils.PackageParserCompat;
import droid.game.virtualapk.internal.utils.PluginUtil;
import droid.game.virtualapk.internal.utils.WebViewResourceHelper;
 ...
 */
public class LoadedPlugin implements droid.game.plugin.manager.LoadedApk {
    ...
    protected ClassLoader createClassLoader(Context context, File apk, File libsDir, ClassLoader parent) throws Exception {
        ...
        Log.e("pluginCreate","create DexClassLoader" + " duration:" + (System.currentTimeMillis() - duration));

        if (Constants.COMBINE_CLASSLOADER()) {
            DexUtil.insertDex(loader, parent, libsDir);
            Log.e("pluginCreate","combine ClassLoader" + " duration:" + (System.currentTimeMillis() - duration));
        }
    ...
    protected VirtualApk mPluginManager;
    ...
    protected boolean mDebugDuration = true;

    protected Application mApplication;

    public LoadedPlugin(VirtualApk pluginManager, Context context, File apk) throws Exception {
        ...
        Log.e("pluginCreate","parsePackage" + " duration:" + (System.currentTimeMillis() - duration));
        ...
        Log.e("pluginCreate","createPluginPackageManager" + " duration:" + (System.currentTimeMillis() - duration));

        this.mPluginContext = createPluginContext(null);
        Log.e("pluginCreate","createPluginContext" + " duration:" + (System.currentTimeMillis() - duration));
        ...
        Log.e("pluginCreate","createResources" + " duration:" + (System.currentTimeMillis() - duration));

        this.mClassLoader = createClassLoader(context, apk, this.mNativeLibDir, context.getClassLoader());
        Log.e("pluginCreate","createClassLoader" + " duration:" + (System.currentTimeMillis() - duration));

        tryToCopyNativeLib(apk);
        Log.e("pluginCreate","tryToCopyNativeLib" + " duration:" + (System.currentTimeMillis() - duration));

        WebViewResourceHelper.addChromeResourceIfNeeded(mPluginContext);
        Log.e("pluginCreate","addChromeResourceIfNeeded" + " duration:" + (System.currentTimeMillis() - duration));
    ...
    public VirtualApk getPluginManager() {
    ...
    protected class PluginPackageManager extends PackageManager {
        ...
        public PackageInfo getPackageInfo(String packageName, int flags) throws NameNotFoundException {
            ...
            LoadedPlugin plugin = (LoadedPlugin) mPluginManager.getLoadedPlugin(packageName);
            if (null != plugin) {
        ...
        public PackageInfo getPackageInfo(VersionedPackage versionedPackage, int i) throws NameNotFoundException {
            ...
            LoadedPlugin plugin = (LoadedPlugin) mPluginManager.getLoadedPlugin(versionedPackage.getPackageName());
            if (null != plugin) {
                return plugin.mPackageInfo;
            }
