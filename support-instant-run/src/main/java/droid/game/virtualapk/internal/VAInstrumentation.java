...
import droid.game.virtualapk.delegate.StubActivity;
...
public class VAInstrumentation extends Instrumentation implements Handler.Callback {
    ...
    public VAInstrumentation(VirtualApk pluginManager, Instrumentation base) {
    ...
    protected void injectActivity(Activity activity) {
        ...
        if (PluginUtil.isIntentFromPlugin(intent)) {
            ...
            try {
                LoadedPlugin plugin = (LoadedPlugin) this.mPluginManager.getLoadedPlugin(intent);
