...
public class SuspenLight implements Theme {
    public static Theme theme() {
        return Holder.holder;
    }

    private final int COLOR_BACKGROUND = Color.parseColor("#ffffff");
    private final int COLOR_STROKEN = Color.parseColor("#15000000");

    private final int TITLE_TEXT_COLOR = Color.parseColor("#3478f6");
    ...
    private final int CONTENT_TEXT_COLOR = Color.parseColor("#333333");
    ...
    private final int BUTTON_BACKGROUND_COLOR = Color.parseColor("#15000000");
    private final int BUTTON_BACKGROUND_COLOR1 = Color.parseColor("#15666666");
    private final int BUTTON_TEXT_COLOR = Color.parseColor("#3478f6");
    ...
    private static class Holder {
        private static final Theme holder = new SuspenLight();
    }
}
