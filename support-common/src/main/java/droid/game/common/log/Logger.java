...
import droid.game.common.log.file.LogFileParam;
import droid.game.common.log.parser.LocalParserManager;
import droid.game.common.log.utils.ObjectUtil;

import static droid.game.common.log.LogLevel.*;
import static droid.game.common.log.utils.Utils.*;
...
class Logger implements Printer {
    ...
    private StackTraceElement getCurrentStackTrace() {
        ...
        int stackOffset = getStackOffset(trace, LogRecord.class);
        if (stackOffset == -1) {
