...
import droid.game.common.util.UILayoutHelper;

public class UIDialogLayoutView extends UIDialogAlphaView implements IUILayout {
    private UILayoutHelper mLayoutHelper;

    public UIDialogLayoutView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public UIDialogLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UIDialogLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
