package droid.game.gradle.fataar
...
class VariantProcessor {
     ...
     * Adding "android.disableResourceValidation=true" to "gradle.android.gamecenter.system" can do a trick to skip the exception, but is not recommended.
     */
