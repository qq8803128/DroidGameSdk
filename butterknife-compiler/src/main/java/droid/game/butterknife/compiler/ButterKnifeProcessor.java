...
import droid.game.butterknife.annotation.*;
import droid.game.butterknife.annotation.Optional;
...
public final class ButterKnifeProcessor extends AbstractProcessor {
    ...
    /*
    static boolean isImplementsOfType(TypeMirror typeMirror, String otherType){
