...
import static droid.game.butterknife.compiler.BindingSet.UTILS;
import static droid.game.butterknife.compiler.BindingSet.requiresCast;
    ...
    CodeBlock render(boolean debuggable) {
        ...
        for (int i = 0; i < ids.size(); i++) {
            ...
            if (!debuggable) {
                ...
                builder.add("(source, (int)Utils.id(ctx, \"$L\"), \"field '$L'\"", id.code, name);
                if (requiresCast) {
