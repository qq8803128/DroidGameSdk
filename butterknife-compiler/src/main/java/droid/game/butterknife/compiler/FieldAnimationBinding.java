...
import static droid.game.butterknife.compiler.BindingSet.ANIMATION_UTILS;
...
final class FieldAnimationBinding implements ResourceBinding {
    ...
    @Override public CodeBlock render(int sdk) {
        return CodeBlock.of("target.$L = $T.loadAnimation(ctx, (int)Utils.id(ctx,\"$L\"))", name, ANIMATION_UTILS,
                id.code);
    }
}
