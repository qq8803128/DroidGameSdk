...
import static droid.game.butterknife.compiler.ButterKnifeProcessor.*;
import static java.util.Collections.singletonList;
import static javax.lang.model.element.Modifier.*;

final class BindingSet {
    static final ClassName UTILS = ClassName.get(Utils.class);
    ...
    private static final ClassName UNBINDER = ClassName.get(Unbinder.class);
    static final ClassName BITMAP_FACTORY = ClassName.get("android.graphics", "BitmapFactory");
    static final ClassName ANIMATION_UTILS =
            ClassName.get("android.view.animation", "AnimationUtils");
    static final ClassName CONTEXT_PROVIDER = ClassName.get(IContextProvider.class);
    ...
    private final boolean isContextProvider;
    ...
    private BindingSet(TypeName targetTypeName, ClassName bindingClassName, boolean isFinal,
                       boolean isView, boolean isActivity, boolean isDialog, boolean isContextProvider,ImmutableList<ViewBinding> viewBindings,
    ...
    private MethodSpec createBindingConstructor(int sdk, boolean debuggable) {
        ...
        if (isContextProvider){
            constructor.addStatement("$T contextProvider = (IContextProvider)target",CONTEXT_PROVIDER);
            constructor.addStatement("$T ctx = contextProvider.provideContext()", CONTEXT);
        }else{
            constructor.addStatement("$T ctx = source.getContext()", CONTEXT);
        }
        if (hasTargetField()) {
        ...
        if (hasViewBindings()) {
            //constructor.addStatement("try{$T ctx = target.getContext();}catch(Throwable e){}", CONTEXT);
            if (hasViewLocal()) {
    ...
    private void addViewBinding(MethodSpec.Builder result, ViewBinding binding, boolean debuggable) {
        if (binding.isSingleFieldBinding()) {
            ...
            builder.add("(source, Utils.id(ctx,\"$L\")", binding.getId().code);
        ...
        result.addStatement("view = $T.findRequiredView(source, (int)Utils.id(ctx,\"$L\"), $S)", UTILS,
    ...
    static Builder newBuilder(TypeElement enclosingElement) {
        ...
        boolean isContextProvider = isSubtypeOfType(typeMirror,CONTEXT_PROVIDER.toString());
        System.out.println("contextProvider:"+ isContextProvider);
        ...
        return new Builder(targetType, bindingClassName, isFinal, isView, isActivity, isDialog,isContextProvider);
    }
    ...
    static final class Builder {
        ...
        private Builder(TypeName targetTypeName, ClassName bindingClassName, boolean isFinal,
                        boolean isView, boolean isActivity, boolean isDialog,boolean isContextProvider) {
            this.targetTypeName = targetTypeName;
            this.bindingClassName = bindingClassName;
            this.isFinal = isFinal;
            this.isView = isView;
        ...
        BindingSet build() {
            ...
            return new BindingSet(targetTypeName, bindingClassName, isFinal, isView, isActivity, isDialog,isContextProvider,
