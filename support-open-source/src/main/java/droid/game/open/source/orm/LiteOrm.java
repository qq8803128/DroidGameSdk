 ...
 */
package droid.game.open.source.orm;

import android.content.Context;
import android.database.Cursor;
import android.database.sqlite.SQLiteClosable;
import android.database.sqlite.SQLiteDatabase;
import droid.game.open.source.orm.db.DataBase;
import droid.game.open.source.orm.db.DataBaseConfig;
import droid.game.open.source.orm.db.TableManager;
import droid.game.open.source.orm.db.assit.*;
import droid.game.open.source.orm.db.impl.CascadeSQLiteImpl;
import droid.game.open.source.orm.db.impl.SingleSQLiteImpl;
import droid.game.open.source.orm.db.model.*;
import droid.game.open.source.orm.db.utils.ClassUtil;
import droid.game.open.source.orm.db.utils.DataUtil;
import droid.game.open.source.orm.db.utils.FieldUtil;
import droid.game.open.source.orm.log.OrmLog;
...
public abstract class LiteOrm extends SQLiteClosable implements DataBase {
    ...
    public SQLiteDatabase openOrCreateDatabase() {
        ...
        mHelper = new SQLiteHelper(mConfig.context.getApplicationContext(),
                mConfig.dbName, null, mConfig.dbVersion, mConfig.onUpgradeListener,mConfig.onDowngradeListener);
     ...
     *
     * @return {@link droid.game.open.source.orm.db.impl.CascadeSQLiteImpl}
     */
