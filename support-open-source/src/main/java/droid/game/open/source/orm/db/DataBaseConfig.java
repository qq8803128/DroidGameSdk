...
import droid.game.open.source.orm.db.assit.SQLiteHelper;
/**
 * 数据操作配置
 *
 * @author MaTianyu
...
public class DataBaseConfig {
    ...
    public SQLiteHelper.OnUpgradeListener onUpgradeListener;
    public SQLiteHelper.OnDowngradeListener onDowngradeListener;
    ...
    public DataBaseConfig(Context context, String dbName) {
        this(context, dbName, false, DEFAULT_DB_VERSION, null,null);
    }

    public DataBaseConfig(Context context, String dbName, boolean debugged,
                          int dbVersion, SQLiteHelper.OnUpgradeListener onUpgradeListener, SQLiteHelper.OnDowngradeListener onDowngradeListener) {
    ...
    public String toString() {
        return "DataBaseConfig [mContext=" + context + ", mDbName=" + dbName + ", mDbVersion="
               + dbVersion + ", mOnUpdateListener=" + onUpgradeListener + "]";
    }
