...
import droid.game.open.source.okhttp3.Cache;
import droid.game.open.source.okhttp3.CacheControl;
import droid.game.open.source.okhttp3.OkHttpClient;
import droid.game.open.source.okhttp3.Request;
...
public class OkHttp3Downloader implements Downloader {
  ...
  @Override public Response load(Uri uri, int networkPolicy) throws IOException {
    ...
    droid.game.open.source.okhttp3.Response response = client.newCall(builder.build()).execute();
