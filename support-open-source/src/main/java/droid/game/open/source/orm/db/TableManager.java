 ...
 */
package droid.game.open.source.orm.db;


import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import droid.game.open.source.orm.db.annotation.Column;
import droid.game.open.source.orm.db.annotation.Mapping;
import droid.game.open.source.orm.db.annotation.PrimaryKey;
import droid.game.open.source.orm.db.annotation.Table;
import droid.game.open.source.orm.db.assit.Checker;
import droid.game.open.source.orm.db.assit.Querier;
import droid.game.open.source.orm.db.assit.SQLBuilder;
import droid.game.open.source.orm.db.assit.Transaction;
import droid.game.open.source.orm.db.enums.AssignType;
import droid.game.open.source.orm.db.assit.SQLStatement;
