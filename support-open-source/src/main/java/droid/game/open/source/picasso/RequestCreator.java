...
import static droid.game.open.source.picasso.BitmapHunter.forRequest;
import static droid.game.open.source.picasso.MemoryPolicy.NO_CACHE;
import static droid.game.open.source.picasso.MemoryPolicy.NO_STORE;
import static droid.game.open.source.picasso.MemoryPolicy.shouldReadFromMemoryCache;
import static droid.game.open.source.picasso.Picasso.LoadedFrom.MEMORY;
import static droid.game.open.source.picasso.Picasso.Priority;
import static droid.game.open.source.picasso.PicassoDrawable.setBitmap;
import static droid.game.open.source.picasso.PicassoDrawable.setPlaceholder;
import static droid.game.open.source.picasso.RemoteViewsAction.AppWidgetAction;
import static droid.game.open.source.picasso.RemoteViewsAction.NotificationAction;
import static droid.game.open.source.picasso.Utils.OWNER_MAIN;
import static droid.game.open.source.picasso.Utils.VERB_CHANGED;
import static droid.game.open.source.picasso.Utils.VERB_COMPLETED;
import static droid.game.open.source.picasso.Utils.VERB_CREATED;
import static droid.game.open.source.picasso.Utils.checkMain;
import static droid.game.open.source.picasso.Utils.checkNotMain;
import static droid.game.open.source.picasso.Utils.createKey;
import static droid.game.open.source.picasso.Utils.log;
